...
public final class MediaType {
	...
	private static final Pattern TYPE_SUBTYPE = Pattern.compile(TOKEN + "/"
			+ TOKEN);
	private static final Pattern PARAMETER = Pattern.compile(";\\s*(?:" + TOKEN
			+ "=(?:" + TOKEN + "|" + QUOTED + "))?");
	...
	/**
	 * Returns a media type for {@code string}, or null if {@code string} is not
	...
	/**
	 * Returns a specific media subtype, such as "plain" or "png", "mpeg", "mp4"
	 * or "xml".
	 */
	...
	/**
	 * Returns the charset of this media type, or null if this media type
	...
	public boolean equals(Object o) {
		return o instanceof MediaType
				&& ((MediaType) o).mediaType.equals(mediaType);
	}
